...
import { Color, darkTheme, Theme } from '@/constants/theme';
import { useColors, useInputVariants, useTextVariants } from '@/hooks/theme';
...
const TI = forwardRef(
  (
    ...
    return (
      <BoxWrapper justifyContent="center" alignItems="center" flexDirection="row" {...rest}>
        <Box flexGrow={1} width="80%">
          <Box flexDirection="row" alignItems="center">
            {floatingLabel && (
              <Text variant="textSmRegular" color="gray.600" fontWeight={floatingLabelWeight}>
                {floatingLabel}
              </Text>
            )}
            {optional && (
        ...
        {TrailingIcon && (
          <TouchableOpacityBox onPress={onTrailingIconPress} {...TrailingIconOptions}>
